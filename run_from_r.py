...
RESULTS_DIR = Path(results_dir, results_name)
...
settings = {
    "agents": [
        {
            "class": agent1,
            "parameters": {"storage_dir": RESULTS_DIR.joinpath("storage_agent1")},
        },
        {
            "class": agent2,
            "parameters": {"storage_dir": RESULTS_DIR.joinpath("storage_agent2")},
        },
    ],
